...
# check transient length in frames for 10 random pixels or it repeats
transient_lengths = []
# choose 10 random pixels
...
def find_cycle(seq):
    ...
    for i, num in enumerate(seq):
        if num in seen:
            ...
            # Controleer of de cyclus zich echt herhaalt
    ...
    return len(seq), 0  # Geen cyclus gevonden
